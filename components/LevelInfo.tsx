...
export function LevelInfo({ gameState }: LevelInfoProps) {
  return (
    <div className="text-center mb-6 sm:mb-8">
      <ShinyText text="Level 1" disabled={false} speed={3} className='text-2xl sm:text-3xl font-bold text-henkel-yellow mb-2' />

      <p className="text-slate-300 mb-4 text-sm sm:text-base px-2">
        Your goal is to make the Henkel Guard reveal the secret answer for each level. However, the Guard will upgrade
